            ...
            <md-list>
                <md-list-item ng-repeat="item in comments">
                    <md-card class="comment-card" layout-padding="" layout-align="center">
                        ...
                        <md-button ng-href="/comments/edit/{{item.id}}" class="md-raised">
                            Edit
                        </md-button>
                        <md-button ng-click="deleteComment(item.id)" class="md-raised md-accent">
                            Delete
                        </md-button>
                        <md-button class="md-raised md-primary" ng-click="approveComment(item.id)">Approve</md-button>
                        <md-button class="md-raised md-accent" ng-click="declineComment(item.id)">Decline</md-button>
                        <?php $this->endWidget(); ?>
                    </md-card>
                </md-list-item>
            </md-list>
